...
import { _addMusic } from '../utils/API';
...
function Sidebar({updateData}) {
  ...
  return (
    <div className="hidden md:flex flex-col md:w-auto bg-[#000] text-white flex-shrink-0">
      ...
      <nav className="flex flex-col p-4 space-y-4">
        ...
        <div className='bg-[#121212] flex flex-col gap-3 py-2 rounded-md '>
          ...
          <button className='p-2 w-10 mx-auto' data-modal-target="crud-modal" data-modal-toggle="crud-modal">
